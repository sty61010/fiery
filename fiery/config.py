...
_C.MODEL.FRUSTUM_TO_BEV = CN(new_allowed=True)
...
_C.LOSS.DEPTH_SUPERVISION = CN(new_allowed=True)
_C.LOSS.DEPTH_SUPERVISION_WEIGHT = CN()
_C.LOSS.DEPTH_SUPERVISION_WEIGHT.ALL = 0.0
_C.LOSS.DEPTH_SUPERVISION_WEIGHT.FOREGROUND = 3.25
_C.LOSS.DEPTH_SUPERVISION_WEIGHT.BACKGROUND = 0.25
